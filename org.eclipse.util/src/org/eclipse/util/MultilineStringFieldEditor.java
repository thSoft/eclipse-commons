...
public class MultilineStringFieldEditor extends FieldEditor {
	 ...
	 * the fly checking (the default), or <code>VALIDATE_ON_FOCUS_LOST</code> to
	 ...
	 *
	 * @param limit the limit on the number of character in the text input field,
	 ...
	 * </p>
	 *
	 * @param value either <code>VALIDATE_ON_KEY_STROKE</code> to perform on the
	 * fly checking (the default), or <code>VALIDATE_ON_FOCUS_LOST</code> to
	 * perform validation only after the text has been typed in
	 */
	 ...
	 * value (<code>VALUE</code> property) provided that the old and new values
	 * are different.
	 * <p>
